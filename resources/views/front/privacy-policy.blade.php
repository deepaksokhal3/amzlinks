...
<div class="app-body in-home">
    <main class="main">
        <section class="section section-landing bg-white how-it-works pt-5 pb-3">
            <div class="container">
                <h3 class="pt-5"> PRIVACY POLICY</h3>
                <small>Last updated February 08, 2019</small>
                <h4><strong>AGREEMENT TO TERMS</strong></h4>
                <p>
                    Thank you for choosing to be part of our community at Honest Light LLC (“Company”, “we”, “us”, or “our”). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy, or our practices with regards to your personal information, please contact us at support@amzlinks.com.
                </p>
                <p>
                    When you visit our website http://amzlinks.com, and use our services, you trust us with your personal information. We take your privacy very seriously. In this privacy notice, we describe our privacy policy. We seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy policy that you do not agree with, please discontinue use of our Sites and our services.
                </p>
                <p>This privacy policy applies to all information collected through our website (such as http://amzlinks.com), and/or any related services, sales, marketing or events (we refer to them collectively in this privacy policy as the "Sites"). </p>

                <p><strong>Please read this privacy policy carefully as it will help you make informed decisions about sharing
your personal information with us. </strong></p>
            </div>
        </section>
        <section class="section section-landing bg-white how-it-works pt-0 pb-3">
            <div class="container">
        ...
        <section class="section section-landing bg-white how-it-works pt-0 pb-3">
            <div class="container">
                ...
                <p>
                    <strong>In  Short: </strong>We collect personal information that you provide to us such as name, address, contact information, passwords and security data, payment information, and social media login data.
                </p>
                ...
                <p>
                    <strong>Social Media Login Data: </strong> We provide you with the option to register using social media account details, like your Facebook, Twitter or other social media account. If you choose to register in this way, we will collect the Information described in the section called "HOW DO WE HANDLE YOUR SOCIAL LOGINS " below.
                </p>
                <p>All personal information that you provide to us must be true, complete and accurate, and you must notify us of any changes to such personal information.</p>

                <span><strong>Information automatically collected</strong></span>

                <p> <strong>In Short: </strong> Some information – such as IP address and/or browser and device characteristics – is collected automatically when you visit our Sites.
                </p>
                ...
                <span><strong>Information collected from other sources</strong></span>
        ...
        <section class="section section-landing bg-white how-it-works pt-0 pb-3">
            <div class="container">
                <h4><strong>2. HOW DO WE USE YOUR INFORMATION?</strong></h4>
                ...
                <ul class="check_ul">
                    ...
                    <li><strong>To enable user­to­user communications.</strong> We may use your information in order to enable user­touser communications with each user's consent.</li>
                    ...
                    <li><strong>For other Business Purposes. </strong>We may use your information for other Business Purposes, such as data analysis, identifying usage trends, determining the effectiveness of our promotional campaigns and to evaluate and improve our Sites, products, services, marketing and your experience.
                    </li>
                </ul>
            </div>
        </section>
        <section class="section section-landing bg-white how-it-works pt-0 pb-3">
            <div class="container">
                <h4><strong>3. WILL YOUR INFORMATION BE SHARED WITH ANYONE?</strong></h4>
                ...
                <ul class="check_ul">
                    <li><strong>Consent:</strong>We may process your data if you have given us specific consent to use your personal information in a specific purpose.
                    </li>
                    <li><strong>Legitimate Interests:  </strong> We may process your data when it is reasonably necessary to achieve our legitimate business interests.
                    </li>
                    <li><strong>Performance of a Contract:  </strong>Where we have entered into a contract with you, we may process your personal information to fulfill the terms of our contract.
                    </li>
        ...
        <section class="section section-landing bg-white how-it-works pt-0 pb-3">
            <div class="container">
                <h4><strong>4. WHO WILL YOUR INFORMATION BE SHARED WITH?</strong></h4>
                ...
                <ul class="check_ul">
                    ...
                    <li><strong>Advertising, Direct Marketing, and Lead Generation:  </strong> Facebook and Google
                    </li>
                    <li><strong>Affiliate Marketing Programs:  </strong>Amazon Affiliate
                    </li>
                    <li><strong>Communicate and Chat with Users:  </strong>Facebook Chat and Live Chat
                    </li>
                </ul>
            </div>
        </section>
        <section class="section section-landing bg-white how-it-works pt-0 pb-3">
            <div class="container">
                <h4><strong>5. DO WE USE COOKIES AND OTHER TRACKING TECHNOLOGIES?</strong></h4>
                ...
                <h4><strong>6. HOW DO WE HANDLE YOUR SOCIAL LOGINS?</strong></h4>
        ...
        <section class="section section-landing bg-white how-it-works pt-0 pb-3">
            <div class="container">
                <h4><strong>7. WHAT IS OUR STANCE ON THIRD­PARTY WEBSITES?</strong></h4>
        ...
        <section class="section section-landing bg-white how-it-works pt-0 pb-3">
            <div class="container">
                <h4><strong>8. HOW LONG DO WE KEEP YOUR INFORMATION?</strong></h4>
        ...
        <section class="section section-landing bg-white how-it-works pt-0 pb-3">
            <div class="container">
                <h4><strong>9. HOW DO WE KEEP YOUR INFORMATION SAFE? </strong></h4>
        ...
        <section class="section section-landing bg-white how-it-works pt-0 pb-3">
            <div class="container">
                <h4><strong>10. DO WE COLLECT INFORMATION FROM MINORS?</strong></h4>
        ...
        <section class="section section-landing bg-white how-it-works pt-0 pb-3">
            <div class="container">
                <h4><strong>11. WHAT ARE YOUR PRIVACY RIGHTS?</strong></h4>
                ...
                <p>If you are resident in the European Economic Area and you believe we are unlawfully processing your personal information, you also have the right to complain to your local data protection supervisory authority. You can find their contact details here: http://ec.europa.eu/justice/dataprotection/bodies/authorities/index_en.htm</p>
        ...
        <section class="section section-landing bg-white how-it-works pt-0 pb-3">
            <div class="container">
                <h4><strong>12. CONTROLS FOR DO­NOT­TRACK FEATURES</strong></h4>
        ...
        <section class="section section-landing bg-white how-it-works pt-0 pb-3">
            <div class="container">
                <h4><strong>13. DO CALIFORNIA RESIDENTS HAVE SPECIFIC PRIVACY RIGHTS?</strong></h4>
        ...
        <section class="section section-landing bg-white how-it-works pt-0 pb-3">
            <div class="container">
                <h4><strong>14. DO WE MAKE UPDATES TO THIS POLICY?</strong></h4>
        ...
        <section class="section section-landing bg-white how-it-works pt-0 pb-3">
            <div class="container">
                <h4><strong>15. HOW CAN YOU CONTACT US ABOUT THIS POLICY?</strong></h4>
                <p>If you have questions or comments about this policy, you may email us at __________ or by post to:</p>
                <ul>
                    <li>Honest Light LLC</li>
                    <li>8880 Rio San Diego Dr #800</li>
